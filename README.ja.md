...
<p align="center">
  <img src="./assets/demo.gif" alt="ひとつのセッションで claude-muster を動かす様子: リポ一覧、ひとつのリポ本来の Claude へのタスク委譲、同じタスクの全リポ一斉送信" width="100%">
</p>

<p align="center"><em>リポを見つけ、ひとつのリポ本来の Claude にタスクを振り、同じタスクを全リポへ一斉に送る。すべてひとつの根から。</em></p>
